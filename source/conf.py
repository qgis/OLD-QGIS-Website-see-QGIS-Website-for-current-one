...
devversion = '2.13'
nextversion = '2.14'
nextfreezedate = datetime(2016, 1, 15, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
nextreleasedate = datetime(2016, 2, 26, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
nextpointreleasedate = datetime(2015, 12, 18, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
