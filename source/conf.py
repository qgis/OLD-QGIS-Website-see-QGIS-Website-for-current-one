...
devversion = '2.99'
nextversion = '3.0'
nextfreezedate = datetime(2017, 9, 15, 12, 0, 0).strftime('%Y-%m-%d %H:%M:%S UTC')
nextreleasedate = datetime(2017, 11, 24, 12, 0, 0).strftime('%Y-%m-%d %H:%M:%S UTC')
nextpointreleasedate = datetime(2017, 7, 21, 12, 0, 0).strftime('%Y-%m-%d %H:%M:%S UTC')
