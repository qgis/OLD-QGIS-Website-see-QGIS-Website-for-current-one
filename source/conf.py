...
devversion = '2.15'
nextversion = '2.16'
nextfreezedate = datetime(2016, 5, 20, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
nextreleasedate = datetime(2016, 6, 24, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
nextpointreleasedate = datetime(2016, 3, 25, 12, 0, 0).strftime('%Y/%m/%d %H:%M:%S UTC')
